...
|---------- |-------------- |---------- |--------------------------------  |-------- |
| data | 表格数据 | any[] | — | [] |
| props | 表头数据 | any[] | [传送门](https://github.com/ciwyaitd/element-table-column) | [] |
| propsKey | 指定 data 数据的字段 key | Object | [传送门](#propsKey) | — |
| 其他 | el-table 指定可用 attributes | — | [传送门](#Table) | — |
...
| data | 表格数据 | any[] | — | [] |
| props | 表头数据 | any[] | [传送门](https://github.com/ciwyaitd/element-table-column) | [] |
| props-key | data 数据指定的字段 key | Object | [传送门](#propsKey) | — |
